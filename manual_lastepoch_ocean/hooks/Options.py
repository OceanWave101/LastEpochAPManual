...
class ExcludeDungeonSkips(Toggle):
    ...
    """
    display_name = "Remove Dungeon Skips from logic"
...
class TrapWeights(OptionDict):
    \"""If traps are enabled, this will set the ratio of trap types to appear.
    If you don't want a specific type of trap to appear, set its weight to 0.
    \"""
    display_name = "Define trap type weights"
    schema = Schema({
    ...
    # eventually this can be actualized as OptionDict but keeping this commented out until then
"""    
